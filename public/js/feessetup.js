class FeesSetUp {
    constructor(_id,amount,purpose,mandetory,_type,crateria,whoShouldPay,accountType) {
       //:amount:purpose:mandetory:_type:crateria:whoShouldPay:accountType
        this.amount=amount;
        ...
        this._view = `<tr id ="${this._id}" >
                    ...
                    <td class="question "> ${this.purpose}</td>
                    <td class="question "> ${this.amount}</td>
                    <td class="question "> ${this.mandetory}</td>
                    <td class="question "> ${this._type}</td>
                    <td class="question "> ${this.crateria}</td>
                    <td class="question "> ${this.whoShouldPay}</td>
                    <td class="question "> ${this.accountType}</td>
                    <td title='edit user'>
