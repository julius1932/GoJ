class Learner {
    constructor(_id,fname,sname,gender,email,phone,klassId) {
       //fname:sname:gender:email:phone:klassId
        this.fname=fname;
        this.sname=sname;
        this.gender=gender;
        this.email=email;
        ...
        this._view = `<tr id ="${this._id}" >
                    ...
                    <td class="question "> ${this.email}</td>
                    <td class="question "> ${this.phone}</td>
                    <td class="question "> ${this.klassId}</td>
                    <td title='edit user'>
